 ...
 <div class="col-sm-6 col-md-4 movie-tile" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p><a href="#" class="btn btn-primary" role="button">Ratings: {movie_rating} / {movie_total_rating} </a> </p>
      </div>
    </div>
  </div>
'''
def create_movie_tiles_content(movies,category):
    ...
    for movie in movies:
        ...
        if category in movie.categories:
            ...
            content += movie_tile_content.format(
                ...
                movie_total_rating = movie.TOTAL_RATING
            )

    if content == '':
        content = '<h4>Stay Tuned For New Movies in this category</h4>'
    return content
